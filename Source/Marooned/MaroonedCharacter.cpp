...
AMaroonedCharacter::AMaroonedCharacter()
{
...
void AMaroonedCharacter::NotifyControllerChanged()
{
...
void AMaroonedCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMaroonedCharacter::Move);
...
void AMaroonedCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
